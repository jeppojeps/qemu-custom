...
{
    uint64_t src_freq; // source frequency
    Clock *current_source = mux->srcs[mux->src]; // current source
    uint32_t freq_multiplier = 0; // frequency multiplier
    bool clk_changed = false;   // clock changed
