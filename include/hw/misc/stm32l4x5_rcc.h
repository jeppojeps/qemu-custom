...
typedef enum PllCommonChannels {
    RCC_PLL_COMMON_CHANNEL_P = 0, //clock main system or peripheral
    RCC_PLL_COMMON_CHANNEL_Q = 1, //clock peripheral for USB, SDMMC, RNG, FDCAN, SWPMI, QSPI
    RCC_PLL_COMMON_CHANNEL_R = 2, //clock peripheral for ADC

    RCC_NUM_CHANNEL_PLL_OUT = 3 //number of PLL output channels
} PllCommonChannels;
...
typedef enum RccClockMux {
    ...
    RCC_CLOCK_MUX_SYSCLK, //system clock
    RCC_CLOCK_MUX_PLL_INPUT, //PLL input
    RCC_CLOCK_MUX_HCLK, //AHB clock
    RCC_CLOCK_MUX_PCLK1, //APB1 clock
    RCC_CLOCK_MUX_PCLK2, //APB2 clock
    RCC_CLOCK_MUX_HSE_OVER_32, //HSE divided by 32
    RCC_CLOCK_MUX_LCD_AND_RTC_COMMON, //LCD and RTC common clock
    ...
    RCC_CLOCK_MUX_I2C1,  //I2C1 clock -> stm32l452re
    RCC_CLOCK_MUX_I2C2,  //I2C2 clock -> stm32l452re
    RCC_CLOCK_MUX_I2C3,  //I2C3 clock -> stm32l452re
    RCC_CLOCK_MUX_LPTIM1, //Low power timer 1 -> stm32l452re
    RCC_CLOCK_MUX_LPTIM2, //Low power timer 2 -> stm32l452re
    RCC_CLOCK_MUX_SWPMI1, //Single wire protocol master interface 1 -> stm32l452re
    RCC_CLOCK_MUX_MCO, //Microcontroller clock output -> stm32l452re
    RCC_CLOCK_MUX_LSCO, //Low speed clock output -> stm32l452re
    RCC_CLOCK_MUX_DFSDM1, //Digital filter for sigma delta modulator 1 -> stm32l452re
    RCC_CLOCK_MUX_ADC, //Analog to digital converter -> stm32l452re
    RCC_CLOCK_MUX_CLK48, //48 MHz clock -> stm32l452re
    RCC_CLOCK_MUX_SAI1, //Serial audio interface 1 -> stm32l452re
    RCC_CLOCK_MUX_SAI2, //Serial audio interface 2 -> stm32l452re
     ...
     */
    /* - AHB1 */
    RCC_CLOCK_MUX_TSC, //Touch sensing controller -> stm32l452re
    RCC_CLOCK_MUX_CRC, //Cyclic redundancy check -> stm32l452re
    RCC_CLOCK_MUX_FLASH, //Flash memory -> stm32l452re
    RCC_CLOCK_MUX_DMA2,
    RCC_CLOCK_MUX_DMA1,
